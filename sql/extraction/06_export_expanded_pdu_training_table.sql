...
-- Replace target_cell / target_pdus after running validation/04_rank_pdu_candidates.sql.
--
-- Current ready-to-run development export:
-- 1) target_cell = 'f'
-- 2) development PDUs: pdu20, pdu21, pdu22, pdu23, pdu24
-- 3) holdout PDUs are exported separately in 07_export_holdout_pdu_training_table.sql
-- 4) time range: window_index 1500-2100
--
-- Cross-cell follow-up recommendation:
-- - next target_cell: 'e'
-- - suggested development PDUs: pdu26, pdu27, pdu30, pdu31
-- - suggested holdout PDUs: pdu29, pdu28
