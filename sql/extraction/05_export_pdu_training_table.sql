-- Purpose: export a contract-aligned PDU x 5-minute training table for one cell and multiple PDUs.
-- Output columns match src/data/dataset_contract.py.
-- Recommended first run: keep one cell, 2-3 PDUs, and a small window_index range to control scan cost.
